  ...
  return (
    <div className="container">
      ...
      <p>
        ...
        when you use our platform to connect your Facebook Page and run ads
        using our services. By using our app or website, you agree to the terms
        described here.
      </p>
      ...
      <ul>
        ...
        <li>Any other information you voluntarily provide through forms or settings.</li>
      </ul>
      ...
      <ul>
        <li>
          Request and manage your Facebook Page as a business asset.
        </li>
        <li>Run ads for your Page using our own ad account, as per your consent.</li>
        <li>Provide performance reports, insights, and analytics about your campaigns.</li>
        <li>Communicate with you regarding your campaigns and account.</li>
        <li>Improve and optimize our platform.</li>
      </ul>

      <h4 className="mt-4">Disclosure of Information</h4>
      <p>We do <strong>not</strong> sell your personal or business data. We may share your
